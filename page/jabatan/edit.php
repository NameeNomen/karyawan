...
<aside class="w-64 bg-white shadow-md flex flex-col justify-between">
    ...
    <div>
        ...
        <nav class="mt-4 space-y-2 text-gray-700 font-medium">
            ...
            <a href="../jabatan/list.php" class="flex items-center gap-3 px-6 py-3 bg-emerald-100 text-emerald-700 font-semibold rounded-r-full">💼 Data Jabatan</a>
            <a href="../departement/list.php" class="flex items-center gap-3 px-6 py-3 hover:bg-emerald-100 rounded-r-full">🏢 Data Departemen</a>
        </nav>
    </div>
...
<main class="flex-1 flex items-center justify-center p-10">
    ...
    <div class="bg-white w-full max-w-2xl p-10 rounded-2xl shadow-lg">
        ...
        <form method="post" class="space-y-6">
            ...
            <div>
                <label class="block font-semibold mb-2">Nama Jabatan</label>
